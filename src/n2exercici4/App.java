...
public class App {
	...
	public static List<String> o2(List<String> lista1) {
		List<String>listaE= lista1.stream()
				.filter(a->a.contains("e")||a.contains("E"))
				.collect(Collectors.toList());
		
		listaE.addAll(((lista1).stream()
	...
	public static List<String> o3(List<String> lista1) {
		return lista1.stream()
				.map(a->a.toLowerCase().replace("a", "4"))
				.collect(Collectors.toList());
	}

	public static List<String> o4(List<String> lista1) {
		return lista1.stream()
				.filter(a -> a.chars().allMatch(value -> Character.isDigit(value)))
				.collect(Collectors.toList());
	}
